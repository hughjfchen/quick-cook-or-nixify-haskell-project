...
defaultPlatformProject.pkgs.lib.mapAttrs (_: pkgs: rec {
  ...
  # java-analyzer-uploader = import ./default.nix { nativePkgs = pkgs;
  #                                    customModules = [ { packages.java-analyzer-uploader.dontStrip = false; } ] ++ (if pkgs.stdenv.hostPlatform.isMusl then
  #                                                       [
  ...
  #                                                         { packages.java-analyzer-uploader.configureFlags =
  #                                                           [
