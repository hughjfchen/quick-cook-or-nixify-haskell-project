...
rec {
  ...
  java-analyzer-runner = (pkgs.haskell-nix.project {
  ...
  java-analyzer-runner-exe = java-analyzer-runner.java-analyzer-runner.components.exes.java-analyzer-runner;
  #java-analyzer-runner-test = java-analyzer-runner.java-analyzer-runner.components.tests.java-analyzer-runner-test;
