...
This is a tool which can help you quickly generate a haskell project with the ~nix~ and ~haskell.nix~ as the build framework.
...
- generate haskell project from scratch with the ~summoner~ tool
- generate most usable nix files, including:
  ...
  - tarball.nix :: this file can be used to tar up as a tarball for the project
